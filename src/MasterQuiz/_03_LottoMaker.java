...
public class _03_LottoMaker {
	public static void main(String[] args) {
		...
		while(lottoNum1 == lottoNum6 || lottoNum2 == lottoNum6 || lottoNum3 == lottoNum6 || lottoNum4 == lottoNum6 || lottoNum5 == lottoNum6) {
			lottoNum6 = (int)(Math.random() * 45 + 1);
		}
		 ...
		 * 
		 * 
		 * System.out.println("1번 번호 : " + lottoNum1); System.out.println("2번 번호 : " +
		 * lottoNum2); System.out.println("3번 번호 : " + lottoNum3);
		 * System.out.println("4번 번호 : " + lottoNum4); System.out.println("5번 번호 : " +
		 * lottoNum5); System.out.println("6번 번호 : " + lottoNum6);
		 */
